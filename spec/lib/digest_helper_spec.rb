...
describe Citygram::DigestHelper do
  describe "deliver_if_digest_day" do
    context 'when digest_day is today' do
      it 'sends the digest' do
        ...
        expect_any_instance_of(Citygram::DigestHelper).to receive(:deliver)

        subject.deliver_if_digest_day
      end
    end
    ...
    context 'when digest_day is not today' do
      it 'does not send the digest' do
        ...
        expect_any_instance_of(Citygram::DigestHelper).not_to receive(:deliver)
